...
import com.korit.BoardStudy.respository.BoardRepository;
...
public class BoardService {
    ...
    public ApiRespDto<?> addBoard(AddBoardReqDto addBoardReqDto, PrincipalUser principalUser) {
        ...
        try {
            ...
            if (result != 1) {
                return new ApiRespDto<>("failed", "게시물 추가에 실패하였습니다.", null);
            }
    ...
    public ApiRespDto<?> getBoardByBoardId(Integer boardId) {
        ...
        Optional<Board> optionalBoard = boardRepository.getBoardByDoardId(boardId);
